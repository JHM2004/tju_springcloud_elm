...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            // 获取商家信息
            let url1 = `BusinessController/getBusinessById/${businessUser.businessId}`;
        ...
        const register = async () => {
            try {
                ...
                const businessData = {
                    ...
                    orderTypeId: user.usertype,
                    businessImg: user.userImg || ''
                };
                
                // 添加请求调试信息
                console.log('提交商家信息，请求数据:', JSON.stringify(businessData));
                
                const response = await axios.post('BusinessController/updateBusiness', businessData);
