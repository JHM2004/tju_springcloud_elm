        ...
        const register = async () => {
            ...
            try {
                ...
                const foodData = {
                    ...
                    foodExplain: user.foodExplain,
                    foodImg: user.foodImg,
                    foodPrice: user.foodPrice,
                    businessId: businessId
                };
                
                console.log('提交食品数据:', foodData.foodName, foodData.foodPrice);
                
                const response = await axios.post('FoodController/addFood', foodData);
